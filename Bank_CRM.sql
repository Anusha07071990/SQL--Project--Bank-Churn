...
SELECT AVG(NumOfProducts) AS AvgProducts_with_CreditCard
FROM bank_churn
WHERE HasCrCard = 1; 
...
#19) According to the age buckets find the number of customers who have a credit card. 
